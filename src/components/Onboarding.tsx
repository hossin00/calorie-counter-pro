...
const SLIDES=[{"accent": "#10b981", "icon": "\ud83e\udd57", "title": "Log meals\nin seconds", "desc": "Search 500,000+ foods or add custom entries. Track calories effortlessly."}, {"accent": "#059669", "icon": "\ud83d\udcca", "title": "Track macros\nautomatically", "desc": "See protein, carbs, and fat breakdowns for every meal."}, {"accent": "#047857", "icon": "\ud83c\udfaf", "title": "Hit your calorie\ngoal every day", "desc": "Set your calorie target and see exactly how much you have left."}];
  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',background:'#08080f',position:'relative'}}>
      ...
      <div style={{padding:'20px 24px',display:'flex',justifyContent:'flex-end'}}>
        <button onClick={onDone} style={{color:'#10b98150',fontSize:'14px',background:'none',border:'none',cursor:'pointer',fontFamily:'Inter'}}>Skip</button>
      </div>
      <div key={idx} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px 32px',textAlign:'center',animation:'sIn .35s ease'}}>
        ...
        <p style={{color:'#10b98170',fontSize:'14px',lineHeight:'1.7',maxWidth:'270px'}}>{slide.desc}</p>
      </div>
